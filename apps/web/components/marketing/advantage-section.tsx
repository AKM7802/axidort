...
const ADVANTAGES: { icon: LucideIcon; title: string; description: string }[] = [
  ...
  {
    icon: TargetIcon,
    title: "Matched to your exact categories & territory",
    description:
      "Set the service categories you sell and the zip codes, boroughs, or radius you work — you only see leads that actually fit your business.",
  },
  {
    icon: LockIcon,
    title: "Optional territory exclusivity",
    description:
      "Turn on exclusivity and a lead in your territory won't be sold to a competitor chasing the same job.",
  },
  {
