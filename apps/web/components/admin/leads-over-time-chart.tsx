...
export function LeadsOverTimeChart({ data }: { data: WeeklyCount[] }) {
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        ...
        <CardDescription>Weekly lead volume across all clients</CardDescription>
      </CardHeader>
      <CardContent>
        {hasData ? (
...
export function LeadsOverTimeChartSkeleton() {
  return (
    <Card className="h-full">
      <CardHeader>
